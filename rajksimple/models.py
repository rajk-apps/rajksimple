...
class Config(models.Model):
    ...
    default_acc = models.ForeignKey('Account',null=True,blank=True,
...
class Account(models.Model):
    ...
    default_cause = models.ForeignKey('Cause',null=True,blank=True,
                                      on_delete=models.DO_NOTHING,
                                      related_name='default_cause')
    
    submittext = models.CharField(max_length=40,
                                  null=True,
                                  blank=True)
...
class Transaction(models.Model):
    ...
    REPS = MARKUP_CHOICES = [(0,'Egyszeri'),
                      (1,'Havonta'),
                      (3,'Negyedévente'),
                      (6,'Félévente'),
                      (12,'Évente')]
